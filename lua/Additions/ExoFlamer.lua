...
local kConeWidth = kExoFlamerConeWidth
local kFireRate = kExoFlamerFireRate
local kCoolDownRate = kExoFlamerCoolDownRate
local kDualGunHeatUpRate = kExoFlamerDualGunHeatUpRate
local kHeatUpRate = kExoFlamerHeatUpRate
