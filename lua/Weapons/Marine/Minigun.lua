...
local kMinigunRange = gExoMinigunRange --400
local kMinigunSpread = gExoMinigunSpread --Math.Radians(5)


local kBulletSize = gExoMinigunBulletSize --0.03

local kHeatUpRate = gExoMinigunHeatUpRate --0.3
local kCoolDownRate = gExoMinigunCoolDownRate --0.4
...
function Minigun:GetTracerEffectFrequency()
    return gExoMinigunTracerEffectFrequency--1
end
...
function Minigun:GetWeight()
    return gExoMinigunWeight --kMinigunWeight
end
