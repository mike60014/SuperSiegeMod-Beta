...
local kTrailLength = kExoFlamerTrailLength
local kImpactEffectRate = kExoFlamerImpactEffectRate
local kSmokeEffectRate = kExoFlamerSmokeEffectRate
local kPilotEffectRate = kExoFlamerPilotEffectRate
...
function ExoFlamer:InitTrailCinematic(effectType, player)
    ...
    local minHardeningValue = kExoFlamerminHardeningValue
    local numFlameSegments = kExoFlamerTrailnumFlameSegments
    ...
    elseif effectType == kEffectType.ThirdPerson then
        ...
        minHardeningValue = kExoFlamer3PminHardeningValue
        numFlameSegments = kExoFlamer3PTrailnumFlameSegments
    ...
    self.trailCinematic:SetOptions( {
            ...
            visibilityChangeDuration = kExoFlameralienvisibilityChangeDuration,
            fadeOutCinematics = true,
            stretchTrail = false,
            trailLength = kTrailLength,
            minHardening = minHardeningValue,
            maxHardening = kExoFlamermaxHardeningValue,
            hardeningModifier = kExoFlamerhardeningModifier,
            trailWeight = kExoFlamerTrailWeight
        } )
